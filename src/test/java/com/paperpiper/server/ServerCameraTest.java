...
class ServerCameraTest {
    ...
    void capturesFrameWithConfiguredResolution() {
        ...
        CameraFramePayload frame = camera.capture("drone-1", null, 1);
    ...
    void cameraPoseChangesPixelContent() {
        ...
        CameraFramePayload frameA = camera.capture("drone-1", null, 2);
        camera.setPose(10f, 20f, 30f, 45f, 10f, -5f);
        CameraFramePayload frameB = camera.capture("drone-1", null, 2);
